      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php
            ...
            elseif ($order && $license->getValidFor()) {
          ...
          <td class="license-key-actions">
            ...
            <a href="<?php echo esc_url(Controller::getAccountLicenseUrl($license->getId())); ?>"
               class="button view"><?php _e('View', 'license-manager-for-woocommerce'); ?></a>
						<?php if ($order) { ?>
              <a href="<?php echo esc_url($order->get_view_order_url()); ?>"
                 class="button view"><?php _e('Order', 'license-manager-for-woocommerce'); ?></a>
						<?php } ?>
          </td>
        </tr>
			<?php endforeach; ?>
